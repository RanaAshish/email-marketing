...
<div class="drop">
    <div style="background-color: black;opacity: 0.5;position: absolute;width:96.5%" class="notdisplayDel" id="del">
        <div style="float: right;">
            ...
            <button type='button' ng-click="chktype('imageCap',$event)" class='edit btn btn-small btn-inverse waves waves-light' btn-type="info" ng-init="type = info"><span class='fa fa-pencil'></span></button>
        </div>
    </div>
    ...
    <div ng-bind-html="con.data" style="padding: 15px;text-align: center;word-wrap: normal;" dnd-nodrag>
