...
(function($) {
    ...
    var EditableTable = {
                ...
                if ($this.hasClass('actions')) {
                    ...
                    else if(i==1)
                    {
                        ...
                        ({
                            ...
                            complete : function()
                            {
                                var cid = $this.find("[name='country']").val();
                                $.ajax
                                ({
                                    type: "post",
                                    url: "../getState/"+cid,
                                    success: function(str)
                                    {
                                        $this.next().html('<select class="form-control input-block" name="state">'+str+'</select>');
                                        $this.next().find("[name='"+data[2]+"']").attr("selected","selected");
                                    }
                                });
                            }
                        });
        ...
        rowSave: function($row) {
            ...
            //////////////////////////////////////////////////////////
            //                                                      //
            //       my codding for adding new City                 //
            //                                                      //
            //////////////////////////////////////////////////////////
            if ($row.hasClass('adding'))
            {
