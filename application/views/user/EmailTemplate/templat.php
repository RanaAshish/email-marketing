                                ...
                                <div class="col-sm-7">
                                    <div class="panel panel-default">
                                        ...
                                        <div class="panel panel-body" id="sortable" >
                                            <div class="no-margn nicescroll todo-list scroll">
                                                <style type="text/css">
                                                    /*for template*/
                                                    .drop
                                                    {
                                                ...
                                                <div ng-repeat="(key, item) in lists.list1" class="col-sm-12 nestedDemo">
                                                    <div ng-include="ctype" dnd-list="item">
...
<script>
    ...
    app.controller("myctr", function($scope, $http, $upload) {
       ...
       $scope.onFileSelectInModel = function($files) {
        ...
        $scope.deleteWidget = function(e, i, k)
        {
