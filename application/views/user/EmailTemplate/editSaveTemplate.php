                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-8">
                                <button type="button" class="btn btn-default" ng-click="editTemplate()">Submit</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<script>
    ...
    app.controller("myctr", function($scope, $http, $upload) {
        ...
        $scope.thumb = "";
        //
        $scope.tmpName = "<?php echo $result->name; ?>";
        ...
        $scope.editTemplate = function()
        {
            ...
            var dt = {'tmpname': $scope.tmpName, 'model': $scope.modelAsJson,'id':<?php echo $result->id; ?>};
            $http({
                url: "<?php echo base_url() . 'index.php/user/saveTemplate/editTemplate' ?>",
                method: "post",
                data: dt
