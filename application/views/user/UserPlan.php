...
<div class="container" ng-cloak="" ng-app="myapp1"  ng-controller="myctr">
    <div class="row">
        ...
        <div class="col-sm-2">
            <a href="<?php echo base_url(); ?>index.php/user/UserPlan/NewPlan/" class="btn btn-success">Activate New Plan</a>
        </div>
    </div>
                    ...
                    <div class="panel-body">
                        <div class="table table-responsive">
                            <table class="table table-bordered">
                                ...
                                <tr id="{{x.id}}" ng-class="{activated:x.id==id}" dir-paginate="x in res|filter:var|orderBy:sortType:sortReverse| itemsPerPage: pageSize" current-page= "currentPage">
                                    <td>{{x.name}}</td>
                                    <td>{{x.duration}}</td>
