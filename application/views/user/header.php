                ...
                <div class="topbar-left">
                    <div class="text-center">
                        <a href="<?php echo base_url().'index.php/user/' ?>" class="logo">
                            <i class="md md-terrain"></i> <span>Email Marketing</span></a>
                    </div>
                </div>
                        ...
                        <div class="">
                            ...
                            <ul class="nav navbar-nav navbar-right pull-right">
                                <li class="dropdown">
                                    ...
                                    <img src="<?php echo base_url(); ?>template/BasicTemplate/<?php echo $userid . '/ProfileImage.jpg?'.  rand(0, 1020304050); ?>" alt="user-img" class="img-circle change"> </a>
