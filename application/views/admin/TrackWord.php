<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">Tracking Word
            </h4>
        </div>
    </div>
...
<script src="<?php echo base_url(); ?>template/adminTemplate/pages/datatables.editable.init_trackword.js">
</script>