<div class="container">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="pull-left page-title">Country
            </h4>
        </div>
    </div>
    <div class="panel" ng-cloak="" ng-app="myapp1" ng-controller="myctr">
        <div class="panel-body">
            ...
            <table class="table table-bordered table-striped" id="datatable-editable" ng-init="record = <?php echo htmlspecialchars($records); ?>">
                <thead>
                    <tr>
                        <th style="width: 85%">Country Name
                        </th>
                        <th>Actions
                        </th>
                    </tr>
...
<script src="<?php echo base_url(); ?>template/adminTemplate/pages/datatables.editable.init_country.js">
</script>