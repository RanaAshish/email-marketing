        ...
        <div  id="viewform" >
            ...
            <div class="table table-responsive">
                <table class="table table-bordered table-striped">
                    <tr>
                        <td colspan="5">
                            <input type="text"   class="form-control" style="width: 20%" placeholder="Search" ng-model="var"/>
                        </td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr dir-paginate="x in res|filter:var|orderBy:sortType:sortReverse| itemsPerPage: 3" current-page= "currentPage">
                        <td>{{x.name}}</td>
                        <td>{{x.maximum_subscriber}}</td>
                        <td>{{x.maximum_mail}}</td>
                        <td>{{x.duration}}</td>
                        <td><a href="<?php echo base_url() . 'index.php/admin/managePlan/edit/'; ?>{{x.id}}">Edit</a>
                            <a href="<?php echo base_url() . 'index.php/admin/managePlan/delete/'; ?>{{x.id}}">Delete</a></td>
                    </tr>
                </table>
