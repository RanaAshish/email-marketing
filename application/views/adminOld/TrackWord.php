<div id="page-wrapper">
    <div class="container-fluid">
        ...
        <div  id="viewform" ng-app="myapp1" ng-controller="myctr" class="table table-responsive">
            <table class="table table-bordered table-striped" ng-init="record = <?php echo htmlspecialchars($records); ?>">
                <tr>
                    <td colspan="3">
                        <input type="text" class="form-control" style="width:35%;float:left" placeholder="Search" ng-model="search">
                ...
                <tr dir-paginate="row in record| filter:search |orderBy:sortType:sortReverse| itemsPerPage: pageSize" current-page= "currentPage" id="{{row.id}}}">
                    ...
                    &nbsp;<a class="delete" href="<?php echo base_url() . 'index.php/admin/trackWord/Delete/'; ?>{{row.id}}"><span class="glyphicon glyphicon-trash"></span></a></td>
                </tr>
            </table>
        ...
        <div id="addform" style="visibility: hidden; display: none">
            <form class="form-horizontal" role="form" method="post" action="<?php echo base_url(); ?>index.php/admin/trackWord/Insert/">
                <div class="form-group">
                    <label class="control-label col-sm-2" for="name"> Track Word :</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="word" id="name" required="" placeholder="Enter Name of Country">
                    </div>
                </div>
                <div class="form-group">
        ...
        <div id="editform" style="visibility: hidden; display: none">
            <form class="form-horizontal updateForm" role="form" method="post">
                <div class="form-group">
                    <label class="control-label col-sm-2" for="name"> Track Word :</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="word" id="word" required="" placeholder="Enter Tracking Word">
                    </div>
                </div>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-8">
    ...
    <script type="text/javascript">
        $('document').ready(function(){
            $("#viewform").on("click",".edit",function(){
                 $(".updateForm").attr("action","<?php echo base_url()."index.php/admin/trackWord/update/"; ?>" + $(this).closest("tr").attr("id"));
                 $("#word").val($(this).closest("tr").children().first().html());
            });
        });
    </script>